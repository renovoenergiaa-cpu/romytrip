# Graph Report - Romy 0.1  (2026-09-23)

## Corpus Check
- 309 files · ~222,991 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 17 file(s) not represented in the graph (top: (none) 12, .toml 3, .zip 1)

## Summary
- 1448 nodes · 2122 edges · 272 communities (85 shown, 187 thin omitted)
...
2. `react` - 51 edges
3. `useTheme()` - 47 edges
4. `lucide-react-native` - 43 edges
5. `spacing` - 39 edges
6. `typography` - 37 edges
7. `expo-router` - 35 edges
8. `colors` - 29 edges
9. `supabase` - 24 edges
10. `useOnboardingStore` - 18 edges
...
- `LoginScreen()` --calls--> `useOnboardingStore`  [EXTRACTED]
  app/(auth)/login.tsx → src/store/onboardingStore.ts
- `Step1PersonalScreen()` --calls--> `useOnboardingStore`  [EXTRACTED]
  app/(auth)/onboarding/step1-personal.tsx → src/store/onboardingStore.ts

## Import Cycles
- None detected.

## Communities (272 total, 187 thin omitted)

### Community 0 - "useOnboardingStore"
Cohesion: 0.15
Nodes (16): Step1PersonalScreen(), Step2TripScreen(), Step3TravelStyleScreen(), styles, stylesList, interestsList, Step4InterestsScreen(), styles (+8 more)

### Community 1 - "(tabs)/index.tsx"
Cohesion: 0.07
Nodes (40): CommunitiesScreen(), ITunesSong, RomyFeedScreen(), styles, { width, height }, expo-av, expo-blur, react-native-reanimated (+32 more)

### Community 2 - "dependencies"
Cohesion: 0.05
Nodes (43): dependencies, base64-arraybuffer, expo, expo-av, expo-blur, expo-camera, expo-constants, expo-file-system (+35 more)
...
### Community 6 - "colors"
Cohesion: 0.13
Nodes (17): LoginScreen(), styles, GENDER_PREFS, INTENTIONS, Step6ConnectionsScreen(), styles, MOCK_PROFILES, styles (+9 more)
...
Cohesion: 0.06
Nodes (62): AudioPlayer(), ChatDetailScreen(), getStyles(), { width: SCREEN_WIDTH, height: SCREEN_HEIGHT }, CommunityScreen(), getStyles(), AVAILABLE_AVAILABILITIES, AVAILABLE_BUDGETS (+54 more)

### Community 9 - "communities.tsx"
Cohesion: 0.23
Nodes (10): CommunityCard(), s, TYPE_COLORS, typeColors(), typeIcon(), AVAILABLE_ICONS, EditEventModal(), EditEventModalProps (+2 more)

### Community 10 - "package.json"
Cohesion: 0.07
Nodes (27): main, name, private, version, dotenv, expo-camera, expo-constants, expo-font (+19 more)

### Community 11 - "help-board.tsx"
Cohesion: 0.18
Nodes (17): FreeStatusScreen(), CAT, catConf(), CATEGORIES, CategoryKey, HelpBoardScreen(), s, DiscoveryModal() (+9 more)

### Community 12 - "app/_layout.tsx"
Cohesion: 0.29
Nodes (4): IncomingCallBanner(), styles, { width: SCREEN_WIDTH }, AuthProvider()
...
Cohesion: 0.13
Nodes (24): getStyles(), NotificationSettingsScreen(), getStyles(), SettingsScreen(), styles, TabLayout(), styles, { width } (+16 more)

### Community 15 - "connections.tsx"
Cohesion: 0.09
Nodes (20): styles, ConnectionsScreen(), getStyles(), { width: SCREEN_WIDTH }, expo-haptics, expo-linear-gradient, AnimatedPressable, MatchingActionButton() (+12 more)
...
Cohesion: 0.17
Nodes (12): styles, BirthDatePicker(), BirthDatePickerProps, MONTHS, styles, Chip(), ChipProps, styles (+4 more)

### Community 19 - "Step 2: Choose a Deploy Method"
Cohesion: 0.10
...
### Community 26 - "React Composition Patterns"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (8): FAQ_LIST, FAQItem, getStyles(), HelpSupportScreen(), DEFAULT_PRIVACY, getStyles(), PrivacySecurityScreen(), expo-router
...
Cohesion: 0.29
Nodes (7): devDependencies, dotenv, eslint, eslint-config-expo, playwright, @types/react, typescript
...
### Community 101 - "7. JavaScript Performance"
Cohesion: 0.13
...
### Community 103 - "React Native Skills"
Cohesion: 0.13
...
### Community 105 - "6. Rendering Performance"
Cohesion: 0.17
...
### Community 106 - "React Composition Patterns"
Cohesion: 0.18
...
### Community 107 - "3. Server-Side Performance"
Cohesion: 0.18
...
Cohesion: 0.16
Nodes (15): styles, lucide-react-native, CityAutocomplete(), CityAutocompleteProps, PhotonFeature, styles, CreateCommunityModal(), styles (+7 more)

### Community 109 - "React Composition Patterns"
Cohesion: 0.20
...
### Community 110 - "React Best Practices"
Cohesion: 0.20
...
### Community 112 - "9. User Interface"
Cohesion: 0.20
...
### Community 115 - "2. List Performance"
Cohesion: 0.22
...
### Community 119 - "1. Eliminating Waterfalls"
Cohesion: 0.29
...
### Community 120 - "2. Bundle Size Optimization"
Cohesion: 0.29
...
### Community 127 - "Use Native Navigators for Navigation"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (4): 1. Graphify — Compreensão Arquitetural e Grafo de Dependências, 2. Ponytail — Filosofia de Código Minimalista e Qualidade, 3. Agent Skills — Especialização de Domínio (React Native, Expo & Vercel), Integração de Ferramentas: Graphify, Ponytail & Agent Skills
...
### Community 134 - "8. Advanced Patterns"
Cohesion: 0.40
...
### Community 135 - "Web Interface Guidelines"
Cohesion: 0.40
Nodes (4): Guidelines Source, How It Works, Usage, Web Interface Guidelines

### Community 136 - "themeStore.ts"
Cohesion: 0.40
Nodes (4): @react-native-async-storage/async-storage, zustand, ThemeMode, ThemeState
...
### Community 142 - "Prefer Statically Analyzable Paths"
Cohesion: 0.50
Nodes (3): File-System Paths, Import Paths, Prefer Statically Analyzable Paths

### Community 144 - "3. Animation"
Cohesion: 0.50
...
## Knowledge Gaps
- **709 isolated node(s):** `name`, `slug`, `version`, `orientation`, `icon` (+704 more)
...
- **Why does `react-native` connect `react-native` to `useOnboardingStore`, `(tabs)/index.tsx`, `collapsible.tsx`, `ProximaViagemScreen.tsx`, `colors`, `chat/[id].tsx`, `communities.tsx`, `package.json`, `help-board.tsx`, `lucide-react-native`, `app/_layout.tsx`, `theme/index.ts`, `connections.tsx`, `react`, `spacing`, `expo-router`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `@supabase/supabase-js` connect `@supabase/supabase-js` to `test_onboarding_e2e.js`, `colors`, `chat/[id].tsx`, `package.json`, `test_all_screens_authenticated.js`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `useOnboardingStore`, `(tabs)/index.tsx`, `external-link.tsx`, `collapsible.tsx`, `ProximaViagemScreen.tsx`, `colors`, `chat/[id].tsx`, `communities.tsx`, `package.json`, `help-board.tsx`, `lucide-react-native`, `app/_layout.tsx`, `theme/index.ts`, `connections.tsx`, `spacing`, `expo-router`, `react-native`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **What connects `name`, `slug`, `version` to the rest of the system?**
  _709 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `useOnboardingStore` be split into smaller, more focused modules?**
